...
std::vector<std::string> midiSoundNames = {
        "原声钢琴", "明亮原声钢琴", "电子钢琴", "古筝钢琴", "电子钢琴 1", "电子钢琴 2", "大键琴", "克拉维", "钢片琴",
        "钟琴",
        ...
        "合成音 3 (风琴)", "合成音 4 (长音片)", "合成音 5 (夏朗琴)", "合成音 6 (声音)", "合成音 7 (五度)",
        "合成音 8 (贝斯 + 合成)",
        "合成音 1 (新世纪)", "合成音 2 (温暖)", "合成音 3 (多音乐器)", "合成音 4 (合唱)", "合成音 5 (弓弦)",
        "合成音 6 (金属)", "合成音 7 (光环)", "合成音 8 (扫掠)",
        "特效音 1 (雨)", "特效音 2 (电影音轨)", "特效音 3 (水晶)", "特效音 4 (大气)", "特效音 5 (明亮)",
        "特效音 6 (小妖精)", "特效音 7 (回声)", "特效音 8 (科幻)",
